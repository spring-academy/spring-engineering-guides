...
PORTAL_NAME = spr-eng-guides
COURSE_NAME = spring-engineering-guides
REPOSITORY_NAME = spring-engineering-guides
...
deploy-workshops: update-workshops
	kubectl apply -f workshops/local-dev-portal.yaml
...
delete-workshops:
	-kubectl delete -f workshops/local-dev-portal.yaml --cascade=foreground
